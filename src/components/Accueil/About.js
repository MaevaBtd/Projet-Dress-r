...
const About = () => (
  <div id="about">
    ...
    Besoin de conseils en boutique pour l'achat d'un nouveau
    vêtement qui irait parfaitement avec votre haut préféré ?
    ...
    <p>
    Fier(e)  de cette sublime tenue du jour de l'an, mais vous avez peur de l'oublier ?
    Enregistrez la !
